...
func ParseMetadata(fields int, data []byte) (Metadata, error) {
	...
	case MetadataContentOneField:
		if len(data) < 1 {
			return Metadata{}, errors.New("invalid metadata length for 1 field")
		}
	...
	case MetadataContentTwoField:
		if len(data) < 6 {
			return Metadata{}, errors.New("invalid metadata length for 2 field")
		}
	...
	case MetadataContentThreeField:
		if len(data) < 10 {
			return Metadata{}, errors.New("invalid metadata length for 3 field")
		}
